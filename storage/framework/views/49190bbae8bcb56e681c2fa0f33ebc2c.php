                ...
                <div class="chat-messages" id="messages">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <?php else: ?>
                            ...
                            <div class="msg-wrap <?php echo e($msg['mine'] || (isset($msg['sender_role']) && $msg['sender_role'] === 'agent') ? 'mine' : ''); ?>"
                                id="m-<?php echo e($msg['id']); ?>">
                                <?php if(!$msg['mine']): ?>
                                        ...
                                        <?php $__currentLoopData = $msg['attachments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($att['is_image']): ?>
                                                <img src="<?php echo e($att['url']); ?>" class="att-img"
                                                    onclick="lightbox('<?php echo e($att['url']); ?>')" alt="<?php echo e($att['name']); ?>">
                                            <?php else: ?>
                                                <div class="att-pill" onclick="window.open('<?php echo e($att['url']); ?>')">
                                                    <span
                                                        class="att-icon"><?php echo e(str_contains($att['mime'], 'pdf') ? '📄' : '📎'); ?></span>
                                                    <div>
                ...
                <div class="info-section">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-body">
                            ...
                            <?php echo e($session->customer->bitrix_deal_id ?? '—'); ?>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-body">
                            ...
                            <?php echo e($session->customer->bitrix_contact_id ?? '—'); ?>

                        </div>
                    </div>

                    <?php if(!empty($session->bitrix_deal_link)): ?>
                        <div class="link-copy-block"><a href="<?php echo e($session->bitrix_deal_link ?? ''); ?>"
                                          target="_blank" rel="noopener noreferrer"><?php echo e($session->bitrix_deal_link ?? ''); ?></a>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="info-section">
                        ...
                        <div class="link-copy-block">
                            <?php echo e(url('/c/' . $session->agent_id)); ?>?cid=<?php echo e(urlencode($session->customer_ref ?? '')); ?>&token=<?php echo e($session->session_token); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/sangharshsulke/Axis Data/communication-dash/resources/views/chat/agent-session.blade.php ENDPATH**/ ?>